...
import { ChevronUp, Clock, MoreHorizontal, RefreshCw } from "lucide-react";
            ...
            <TableRow>
              ...
              >
                <div className="flex items-center">Date {sortConfig.field === 'date' && (
                  sortConfig.direction === 'asc' ? (<ChevronUp className="ml-1 h-4 w-4"/>) : (<ChevronUp className="ml-1 h-4 w-4"/>)
                )}</div>
              </TableHead>
